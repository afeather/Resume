...
\begin{tabular}{p{2.1cm}|p{14.9cm}}
	...
	2013 - 2014 & Web Developer for Axvault.com\\&\footnotesize{This commercial guitar website was converted from a Wordpress and Code Igniter hybrid platform to a pure Wordpress platform. The work also included fixing minor problems with the website and adding new features.}\\\multicolumn{2}{c}{} \\
	Summer 2013 & Web Developer intern at BMighty2, Lincoln VT\\&\footnotesize{BMighty2 develops small business websites using Wordpress. Responsibilities included working with PHP, SQL, CSS and JavaScript to develop Wordpress templates, plug-ins and widgets to meet the customer's needs.}\\\multicolumn{2}{c}{} \\
\end{tabular}
